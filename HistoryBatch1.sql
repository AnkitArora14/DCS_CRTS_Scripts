--select * from src.HistBatch1


--SELECT *  FROM [DCS_CRTS].[src].[histbatch1]
...
/*
  ...
  d.[Project Name] as  CRProjectName, --Application
...
--d.title2 as grantorTitle2,
  ...
  d.[Received Date] as submitteddate, --Application
...
--d.title2 as grantorTitle2,
  ...
  d.submission_type as applicationSubmissionType, --Application questions
  d.Restriction_Acres as premiseAcres, --Premise
  DATEADD(HOUR, 5, d.[received date]) as submitteddate, --Application
  d.DCS_grant_Program,
